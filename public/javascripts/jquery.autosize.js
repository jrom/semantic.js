...
(function ($, undefined) {
    ...
    // Original author: line-height is omitted because IE7/IE8 doesn't return the correct value.
    // Cool user: I'm Jack! You know who I am? I am the one that is re-adding line-height ;B
    copyStyle = [
        'fontFamily',
        'fontSize',
        'fontWeight',
